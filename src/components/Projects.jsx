...
const Projects = () => {
    const projectsData = [
        {
        title: "BanHADEX: Towards Explainable HAte Speech Detection in Bangla Using Human Annotated EXplanation.ACL 2026 (Main Conference, Long Paper)",
        ...
        {
        title: "BanHate: An Up-to-Date and Fine-Grained Bangla Hate Speech Dataset( BLP-2025 @ IJCNLP-AACL 2025.)",
        ...
        {
        title: "LLM4Review: A Pretrained Transformer-Based Framework for Multi-Language Code Review (16th ICCCNT 2025)",
